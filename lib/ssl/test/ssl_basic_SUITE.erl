...
psk_cipher_suites(doc)->
    ["Test the PSK ciphersuites WITHOUT server supplied identity hint"];
psk_cipher_suites(suite) ->
    [];
...
psk_with_hint_cipher_suites(doc)->
    ["Test the PSK ciphersuites WITH server supplied identity hint"];
psk_with_hint_cipher_suites(suite) ->
    [];
...
srp_cipher_suites(doc)->
    ["Test the SRP ciphersuites"];
srp_cipher_suites(suite) ->
    [];
...
srp_dsa_cipher_suites(doc)->
    ["Test the SRP DSA ciphersuites"];
srp_dsa_cipher_suites(suite) ->
    [];
